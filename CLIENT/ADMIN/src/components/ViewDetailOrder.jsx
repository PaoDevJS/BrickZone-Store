...
const ViewDetailOrder = ({ orderId, setOrderId, setViewDetail }) => {
    ...
    <div className={`fixed top-0 bottom-0 right-0 left-0 bg-black/20 z-50`}>
      <div className="flex items-center justify-center w-full h-full">
        <div className="w-[90%] max-h-[90%] bg-white rounded-md border border-gray-200 p-10">
          <h1 className="text-center text-xl font-[700] uppercase">
            Chi tiết đơn hàng
          </h1>
          <div className="mt-10 flex gap-5">
            ...
            <div className="w-[65%]">
              ...
              <div className="bg-[#f2f2f2] py-2 px-5 rounded flex items-center justify-between border border-gray-300">
                ...
                <p className="bg-green-600 py-2 px-4 rounded-md font-[500] text-white">
                  {order.status}
                </p>
              </div>
              {/* center */}
              <div className="mt-5 flex justify-between gap-5">
                <div className="border border-gray-300 min-w-[40%] rounded-md overflow-hidden">
                  <h1 className="bg-[#f2f2f2] py-2 px-4 uppercase font-[600] text-gray-500">
                    Khách hàng
                  </h1>
                ...
                <table className="table-fixed w-full rounded overflow-hidden">
                  <thead>
                    <tr className="bg-red-600 text-white">
                      ...
                      <th className="py-2 w-[20%]">Thành tiền</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="w-[35%] flex flex-col justify-between">
              <div>
                <div className="bg-white border border-gray-300 rounded overflow-hidden text-center">
                  ...
                  <p className="p-3 font-[700] text-RedDrank text-xl">
                    {order.paymentMethod}
                  </p>
                </div>
              ...
              <div className="w-full mt-7">
                <button
                  onClick={() => (setViewDetail(false), setOrderId(""))}
